...
if (isset($_GET["delete"])) {
    $f->deleteFeladottPoggyaszok($_GET["delete"]);
...
<div class="container is-fullhd mt-5">
    <div class="columns is-variable is-desktop">
        ...
        <div class="column has-text-right">
            <a href="poggyasz_feladas.php" class="button is-success">Poggyász feladása</a>
        </div>
    </div>
    <div class="columns is-variable is-desktop">
        <div class="column">
                    ...
                    <?php if (!empty($poggyaszok)) : ?>
                        <?php foreach ($poggyaszok as $poggyasz) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="jegy_poggyasz.php?jegy_id=<?= $_GET["jegy_id"] ?>&delete=<?= $poggyasz["F_ID"] ?>"><i class="fa-solid fa-trash-arrow-up"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else : ?>
